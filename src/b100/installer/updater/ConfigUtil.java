...
public class ConfigUtil {
	...
	public static Map<String, String> loadPropertiesInternal(String path, char seperator) {
		InputStream in = null;
		try {
			...
			throw new RuntimeException("Loading internal properties file: " + path, e);
		}finally {
			try {
				in.close();
			}catch (Exception e) {}
	...
	public static void saveProperties(File file, Map<String, String> properties, char seperator) {
		...
		saveStringToFile(file, string.toString());
	}
